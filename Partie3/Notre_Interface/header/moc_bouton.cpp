/****************************************************************************
** Meta object code from reading C++ file 'bouton.hh'
**
...
#error "The header file 'bouton.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 7, 8), // "aff_test"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 7) // "crypter"

    },
    "Bouton\0aff_test\0\0crypter"
};
...
void Bouton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Bouton *_t = static_cast<Bouton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->aff_test(); break;
        case 1: _t->crypter(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Bouton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Bouton.data,
      qt_meta_data_Bouton,  qt_static_metacall, nullptr, nullptr}
};
